...
const forecast=(latitude,longitude,callback)=>
{
    ...
    { if(error)
        ...
        {   const dat=body
            const s=dat.daily.data[0].summary+' It is currently '+dat.currently.temperature+' degrees farehnheit out. There is '+dat.currently.precipProbability+'% chance of rain'
